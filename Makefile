...
HTTP_REQUEST_BODY_TEST := $(BIN_DIR)/ckarta-http-request-body-test
...
$(CONNECTION_TEST): tests/connection/ck_connection_test.c c/connection/ck_connection.c c/connection/ck_connection.h c/output/ck_http_output_writer.c c/output/ck_http_output_writer.h c/http/ck_http_connection_reader.c c/http/ck_http_connection_reader.h c/http/ck_http_request_body.c c/http/ck_http_request_body.h c/http/ck_http_input.c c/http/ck_http_input.h c/http/ck_http_parser.c c/http/ck_http_parser.h c/http/ck_http_chunked.c c/http/ck_http_chunked.h c/platform/ck_socket.c c/platform/ck_socket.h
	@mkdir -p $(BIN_DIR)
	$(CC) $(CFLAGS) tests/connection/ck_connection_test.c c/connection/ck_connection.c c/output/ck_http_output_writer.c c/output/ck_http_response.c c/http/ck_http_connection_reader.c c/http/ck_http_request_body.c c/http/ck_http_input.c c/http/ck_http_parser.c c/http/ck_http_chunked.c c/platform/ck_socket.c -o $@
...
$(CONNECTION_REGISTRY_TEST): tests/connection/ck_connection_registry_test.c c/connection/ck_connection_registry.c c/connection/ck_connection_registry.h c/connection/ck_connection.c c/connection/ck_connection.h c/output/ck_http_output_writer.c c/output/ck_http_output_writer.h c/http/ck_http_connection_reader.c c/http/ck_http_connection_reader.h c/http/ck_http_request_body.c c/http/ck_http_request_body.h c/http/ck_http_input.c c/http/ck_http_input.h c/http/ck_http_parser.c c/http/ck_http_parser.h c/http/ck_http_chunked.c c/http/ck_http_chunked.h c/platform/ck_socket.c c/platform/ck_socket.h
	@mkdir -p $(BIN_DIR)
	$(CC) $(CFLAGS) tests/connection/ck_connection_registry_test.c c/connection/ck_connection_registry.c c/connection/ck_connection.c c/output/ck_http_output_writer.c c/output/ck_http_response.c c/http/ck_http_connection_reader.c c/http/ck_http_request_body.c c/http/ck_http_input.c c/http/ck_http_parser.c c/http/ck_http_chunked.c c/platform/ck_socket.c -o $@
...
$(HTTP_CONNECTION_READER_TEST): tests/http/ck_http_connection_reader_test.c c/http/ck_http_connection_reader.c c/http/ck_http_connection_reader.h c/http/ck_http_request_body.c c/http/ck_http_request_body.h c/http/ck_http_input.c c/http/ck_http_input.h c/http/ck_http_parser.c c/http/ck_http_parser.h c/http/ck_http_chunked.c c/http/ck_http_chunked.h c/platform/ck_socket.c c/platform/ck_socket.h
	@mkdir -p $(BIN_DIR)
	$(CC) $(CFLAGS) tests/http/ck_http_connection_reader_test.c c/http/ck_http_connection_reader.c c/http/ck_http_request_body.c c/http/ck_http_input.c c/http/ck_http_parser.c c/http/ck_http_chunked.c c/platform/ck_socket.c -o $@
...
$(HTTP_OUTPUT_WRITER_TEST): tests/output/ck_http_output_writer_test.c c/output/ck_http_output_writer.c c/output/ck_http_output_writer.h c/output/ck_http_response.c c/output/ck_http_response.h c/event/ck_event_loop.c c/event/ck_event_loop.h c/platform/ck_socket.c c/platform/ck_socket.h
	@mkdir -p $(BIN_DIR)
	$(CC) $(CFLAGS) tests/output/ck_http_output_writer_test.c c/output/ck_http_output_writer.c c/output/ck_http_response.c c/event/ck_event_loop.c c/platform/ck_socket.c -o $@

$(CONNECTION_OUTPUT_INTEGRATION_TEST): tests/output/ck_connection_output_integration_test.c c/connection/ck_connection_registry.c c/connection/ck_connection_registry.h c/connection/ck_connection.c c/connection/ck_connection.h c/output/ck_http_output_writer.c c/output/ck_http_output_writer.h c/output/ck_http_response.c c/output/ck_http_response.h c/event/ck_event_loop.c c/event/ck_event_loop.h c/http/ck_http_connection_reader.c c/http/ck_http_connection_reader.h c/http/ck_http_request_body.c c/http/ck_http_request_body.h c/http/ck_http_input.c c/http/ck_http_input.h c/http/ck_http_parser.c c/http/ck_http_parser.h c/http/ck_http_chunked.c c/http/ck_http_chunked.h c/platform/ck_socket.c c/platform/ck_socket.h
	@mkdir -p $(BIN_DIR)
	$(CC) $(CFLAGS) tests/output/ck_connection_output_integration_test.c c/connection/ck_connection_registry.c c/connection/ck_connection.c c/output/ck_http_output_writer.c c/output/ck_http_response.c c/event/ck_event_loop.c c/http/ck_http_connection_reader.c c/http/ck_http_request_body.c c/http/ck_http_input.c c/http/ck_http_parser.c c/http/ck_http_chunked.c c/platform/ck_socket.c -o $@
...
$(NATIVE_ASYNC_BRIDGE_TEST): tests/native_async_bridge_smoke.c $(JAVA_NATIVE_ASYNC_BRIDGE_TEST) c/jni/ck_async_bridge.c c/jni/ck_async_bridge.h c/connection/ck_connection_registry.c c/connection/ck_connection_registry.h c/connection/ck_connection.c c/connection/ck_connection.h c/http/ck_http_connection_reader.c c/http/ck_http_connection_reader.h c/http/ck_http_request_body.c c/http/ck_http_request_body.h c/http/ck_http_input.c c/http/ck_http_input.h c/http/ck_http_parser.c c/http/ck_http_parser.h c/http/ck_http_chunked.c c/http/ck_http_chunked.h c/platform/ck_socket.c c/platform/ck_socket.h
	@mkdir -p $(BIN_DIR)
	$(CC) $(CFLAGS) $(CPPFLAGS) tests/native_async_bridge_smoke.c c/jni/ck_async_bridge.c c/connection/ck_connection_registry.c c/connection/ck_connection.c c/output/ck_http_output_writer.c c/output/ck_http_response.c c/http/ck_http_connection_reader.c c/http/ck_http_request_body.c c/http/ck_http_input.c c/http/ck_http_parser.c c/http/ck_http_chunked.c c/platform/ck_socket.c -o $@ $(LDFLAGS)
...
test: all $(JAVA_ASYNC_TEST) $(JAVA_SERVLET_API_TEST) $(JAVA_SERVLET_REQUEST_ASYNC_TEST) $(JAVA_NATIVE_ASYNC_BRIDGE_TEST) $(ABI_TEST) $(CONFIG_TEST) $(ERROR_TEST) $(ERROR_RACE_TEST) $(TERMINAL_RACE_TEST) $(COMPLETION_QUEUE_TEST) $(CONNECTION_TEST) $(CONNECTION_REGISTRY_TEST) $(EVENT_LOOP_TEST) $(IO_URING_PROBE_TEST) $(TCP_EVENT_INTEGRATION_TEST) $(HTTP_PARSER_TEST) $(HTTP_CHUNKED_TEST) $(HTTP_INPUT_TEST) $(HTTP_CONNECTION_READER_TEST) $(HTTP_RESPONSE_TEST) $(HTTP_OUTPUT_WRITER_TEST) $(HTTP_REQUEST_BODY_TEST) $(CONNECTION_OUTPUT_INTEGRATION_TEST) $(NATIVE_ASYNC_BRIDGE_TEST)
	...
	$(HTTP_REQUEST_BODY_TEST)
	$(CONNECTION_OUTPUT_INTEGRATION_TEST)
	$(NATIVE_ASYNC_BRIDGE_TEST)
	! $(CONFIG_TEST) tests/config/invalid.conf
	./tests/smoke_bootstrap.sh $(TARGET)

$(HTTP_REQUEST_BODY_TEST): tests/http/ck_http_request_body_test.c c/http/ck_http_request_body.c c/http/ck_http_request_body.h
	@mkdir -p $(BIN_DIR)
	$(CC) $(CFLAGS) tests/http/ck_http_request_body_test.c c/http/ck_http_request_body.c -o $@
