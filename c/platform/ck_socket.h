...
/*
 * Platform socket handles are represented by a Ckarta-owned opaque value.
 * Linux stores the native file descriptor; Windows may store SOCKET.
 * Callers must not interpret value directly.
 */
